...
export function RetroGrid({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed size-full overflow-hidden [perspective:200px]",
        `opacity-[var(--opacity)]`,
        className
      )}
      style={gridStyles}
    ...
    >
      ...
      <div className="fixed inset-0 bg-gradient-to-t from-blue-500 to-transparent to-90% dark:from-black" />
    </div>
  )
}
